...
public class MyStepdefs {
    ...
    public void theUserWillGetAllBooksWithCorrespondingAuthorsThatIsMentionedInThatCityWhichSumsUpToBooks(int arg0) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Given("^a user gives a book title \"([^\"]*)\"$")
    public void aUserGivesABookTitle(String arg0) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
    ...
    public void theUserAskForAllThoseCitiesPlottedOnAMap() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Then("^the user will get a map with all cities mentioned in the book plotted on that map\\.$")
    public void theUserWillGetAMapWithAllCitiesMentionedInTheBookPlottedOnThatMap() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
    ...
    public void theUserAskForAllBooksByThatAuthor() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @And("^the user ask for all cities mentioned in those books$")
    public void theUserAskForAllCitiesMentionedInThoseBooks() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Then("^the user will get a map with all cities mentioned in those books plotted on that map\\.$")
    public void theUserWillGetAMapWithAllCitiesMentionedInThoseBooksPlottedOnThatMap() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Given("^a User gives a location \"([^\"]*)\"$")
    public void aUserGivesALocation(String arg0) throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("^the user ask for all books that mentions cities near that location$")
    public void theUserAskForAllBooksThatMentionsCitiesNearThatLocation() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Then("^the user gets all books mentioning a city near that location$")
    public void theUserGetsAllBooksMentioningACityNearThatLocation() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
}
